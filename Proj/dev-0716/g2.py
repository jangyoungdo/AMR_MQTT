...
class ControlPanel(QWidget):
    ...
    def __init__(self, node, parent=None):
        ...
        # self.setup_serial_connection('/dev/ttyArduino', 115200)  # 시리얼 연결 설정
    ...
    def init_ui(self):
        ...
        lift_height_move_group = QVBoxLayout()
        lift_height_save_group = QVBoxLayout()
        self.height1_move_button = QPushButton("1 Height move")
        self.height2_move_button = QPushButton("2 Height move")
        self.height3_move_button = QPushButton("3 Height move")
        self.height1_save_button = QPushButton("1 Height save")
        self.height2_save_button = QPushButton("2 Height save")
        self.height3_save_button = QPushButton("3 Height save")
        self.height1_move_button.setStyleSheet("font-size: 25px; height: 60px; background-color: lightgrey; border-radius: 10px;")
        self.height2_move_button.setStyleSheet("font-size: 25px; height: 60px; background-color: lightgrey; border-radius: 10px;")
        self.height3_move_button.setStyleSheet("font-size: 25px; height: 60px; background-color: lightgrey; border-radius: 10px;")
        self.height1_save_button.setStyleSheet("font-size: 25px; height: 60px; background-color: lightgrey; border-radius: 10px;")
        self.height2_save_button.setStyleSheet("font-size: 25px; height: 60px; background-color: lightgrey; border-radius: 10px;")
        self.height3_save_button.setStyleSheet("font-size: 25px; height: 60px; background-color: lightgrey; border-radius: 10px;")

        self.height1_move_button.clicked.connect(lambda: self.send_lift_command("move_1", "1"))
        self.height2_move_button.clicked.connect(lambda: self.send_lift_command("move_2", "2"))
        self.height3_move_button.clicked.connect(lambda: self.send_lift_command("move_3", "3"))
        self.height1_save_button.clicked.connect(lambda: self.send_lift_command("save_1", "4"))
        self.height2_save_button.clicked.connect(lambda: self.send_lift_command("save_2", "5"))
        self.height3_save_button.clicked.connect(lambda: self.send_lift_command("save_3", "6"))
        
        lift_height_move_group.addWidget(self.height1_move_button)
        lift_height_move_group.addWidget(self.height2_move_button)
        lift_height_move_group.addWidget(self.height3_move_button)
        lift_height_save_group.addWidget(self.height1_save_button)
        lift_height_save_group.addWidget(self.height2_save_button)
        lift_height_save_group.addWidget(self.height3_save_button)
        ...
        lift_layout.addLayout(lift_height_move_group)
        lift_layout.addLayout(lift_height_save_group)
